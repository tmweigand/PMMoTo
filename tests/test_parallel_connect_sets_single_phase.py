...
def test_connected_sets():
    ...
    connected_sets = pmmoto.core.connect_single_phase(pm,pm.inlet,pm.outlet,phase = 2,return_set=True)
    ...
    for set in connected_sets['sets'].sets:
          ...
          print(_set.global_ID,_set.phase,_set.subdomain_data.inlet,_set.subdomain_data.outlet)
    ...
    if save_data:
        ...
        kwargs = {'inlet':'subdomain_data.inlet',
                  ...
                  'proc':'proc_ID'}
        pmmoto.io.save_set_data("dataOut/test_connect_set_single_phase",sd,connected_sets['sets'],**kwargs)
