...
def my_function():
    ...
    pmmoto.io.save_grid_data("dataOut/grid",sDL,pML.grid,dist=edt)
    ...
    if testSerial:
        ...
        if rank==0:
            if testAlgo:
                ...
                _,sphereData = pmmoto.io.read_sphere_pack_xyzr(file)
                ...
                gridOut = pmmoto.domain_generation.gen_domain_sphere_pack(x,y,z,sphereData)
